      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-[#f5f5f7] rounded-md">
            <p className="text-xs font-semibold text-[#1d1d1f] mb-1">Test Credentials:</p>
            <p className="text-xs text-[rgba(0,0,0,0.56)]">Email: test@student.com</p>
            <p className="text-xs text-[rgba(0,0,0,0.56)]">Password: test123</p>
          </div>
        </CardContent>
      </Card>
    </div>
